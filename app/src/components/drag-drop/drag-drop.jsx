    ...
    render() {
        ...
        const addMenu = (
            <Menu>
                ...
                <MenuItem icon="function" text="Scale" id="scale-btn" onClick={() => this.add_som("scale")} />
            </Menu>
        )
                                        ...
                                        return (
                                            <div key={idx} className="editor-edge-item">
                                                ...
                                                <div className="editor-edge-item-slot">
                                                    <NumericInput id={`input-incoming-${idx}`} fill value={l.props.slot} onValueChange={(v) => this.update_link_slot(l, v)} />
                                                </div>
                                    ...
                                    {this.state.editing == null ? <></> : this.links_for_node(editingNode.id, true).map(function (l, idx) {
                                        ...
                                        return (
                                            <div key={idx} className="editor-edge-item">
                                                <p className="editor-edge-item-text">{other.name}</p>
                                                <div className="editor-edge-item-slot">
                                                    <NumericInput id={`input-outgoing-${idx}`} fill value={l.props.slot} onValueChange={(v) => this.update_link_slot(l, v)} />
                                                </div>
